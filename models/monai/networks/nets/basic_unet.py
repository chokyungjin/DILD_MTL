...
__all__ = ["BasicUNet", "BasicUnet", "Basicunet" , "BasicUNet_Aux"]
...
class BasicUNet_Aux(nn.Module):
    def __init__(
        ...
        fea = ensure_tuple_rep(features, 6)
        print(f"BasicUNet_Aux features: {fea}.")
...
BasicUnet_aux = Basicunet_aux = BasicUNet_Aux
